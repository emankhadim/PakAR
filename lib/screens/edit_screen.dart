...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  var _editedProduct = Products(id: '',
      title: '',
      description: '',
      price: 0,
      imageurl: '');
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (productid != '') {
        _editedProduct =
            Provider.of<ProductProvider>(context, listen: false).findById(
                productid.toString());
        _initvalues = {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Edit Products'),
        actions: [
          ...
          _saveform, icon: Icon(Icons.save))
        ],),
                ...
                children: [
                  Container(
                    ...
                    child: _iamgecontroller.text.isEmpty
                        ...
                        : FittedBox(
                      child: Image.network(
                        _iamgecontroller.text, fit: BoxFit.cover,),
                    ),
                  ),
                  Expanded(
                    child: TextFormField(
